			...
			<div className='flex justify-center content-center gap-1 '>
				{row1.map((letter, index) => {
					if (letter === "backspace") {
						return (
							<div
								className={`letter h-12 w-12 bg-gray-700 border-2 rounded-lg border-gray-400 text-white text-2xl flex justify-center items-center  hover:cursor-pointer`}
								key={`letter-${index}`}
								onClick={() =>
					...
					return (
						<div
							className={`keyboard-letter h-12 w-12 ${bgColor} border-2 rounded-lg border-gray-400 text-white text-2xl flex justify-center items-center  hover:cursor-pointer`}
							key={`letter-${index}`}
							onClick={() =>
			...
			<div className='flex justify-center content-center gap-1'>
				{row2.map((letter, index) => {
					if (letter === "enter") {
						return (
							<div
								className={`letter h-12 grow bg-gray-700 border-2 rounded-lg border-gray-400 text-white text-2xl flex justify-center items-center  hover:cursor-pointer`}
								key={`letter-${index}`}
								onClick={() =>
